...
class Yolov3LogVisualization:
    ...
    def parse_loss_log(self,log_path, line_num=2000):
        result = pd.read_csv(log_path, skiprows=[x for x in range(line_num) if ((x % 10 != 9) | (x < 100))],error_bad_lines=False, names=['loss', 'avg', 'rate', 'seconds', 'images'])
...
if __name__ == '__main__':
    # log_path = '/home/kelly/Desktop/interface-ob/scripts/Mura_LCD4_20181130-155655/log/logfile.log'
    # result_dir = '/home/kelly/OK_darknet/scripts/'
    print(sys.argv[1])
    print(sys.argv[2])
    log_path = sys.argv[1]
